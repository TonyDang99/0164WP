    ...
    <div className="Footer flex space__around pz__15" style={{"borderTop":".3px solid rgba(21,21,21,0.5)"}}>
      ...
      <div className="footer1st">
        ...
        <div className="location flex py__10">
          ...
          <h6>Số 18 - Ngõ 14 - Nguyễn Thị Minh Khai - Phường Hưng Bình - Vinh - Nghệ An</h6>
        </div>
        ...
        <div className="location flex py__10">
          <strong>© 0164 W&P 2021. All right reserved</strong>
        </div>
      ...
      <div className="mobile">
        <div className="footer__2nd__part">
             ...
             <Link to="/login"><h3>Đăng kí</h3></Link>
        ...
        <div className="footer__2nd__part">
             ...
             <Link to="/https://www.instagram.com/0164x2_wp/"><h3>Instagram</h3></Link>
        </div>
      {/* Footer 4th part */}
       {/* <div className="footer__3rd__part">
            <h5>Đối tác</h5>
             <Link to="/creator"><h3>Tài khoản đối tác</h3></Link>
             <Link to="/creator"><h3>Quy tắc </h3></Link>
      ...
      <h5>Hướng dẫn</h5>
      <Link to="/faq"><h3>Hướng dẫn mua hàng</h3></Link>
      <Link to="/contact"><h3>Liên hệ</h3></Link>
      <Link to="/about"><h3>Về chúng tôi</h3></Link>
      {/* <Link to="/creator"><h3>Live Chat</h3></Link> */}
      <Link to="/Products"><h3>Sản phẩm</h3></Link>
        </div>
        </div>
    </div>
  );
